...
export default function Home() {
            ...
            <div className="flex justify-between items-center md:justify-start md:space-x-10 mb-2 mt-5">
              <div className="flex justify-start lg:w-0 lg:flex-1">
                <a href="#">
                  ...
                  <img
                    className="place-items-center h-20 w-20 ml-5"
                    src={logo}
                    alt=""
                  />
                </a>
  ...
  <div className="relative">
   ...
   <img className='brightness-50 w-full pr-0 mb-14 mr-0' src={bgHome} alt="" />
    <div
      className="w-full text-2xl xs:text-4xl sm:text-6xl text-center font-conforter absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white font-extrabold border-spacing-1  p-4"
    >
      3º Tecnoleite 
      <br/>
  ...
  <div className='flex-1 ml-28 mr-4  w-full text-2xl xs:text-4xl sm:text-6xl font-conforter text-black font-bold border-spacing-1'>
    ...
    <p className='text-xl font-normal mt-8 flex-1' style={{ height: 500, width: 500 }}>
      Texto texto texto texto texo texto texto texto texto texto texto texo texto texto texto texto texto texto texo texto
      texto texto texto texto texto texto texo texto texto texto texto texto texto texo texto texto texto texto texto texo
      texto texto texto texto texto texto texo texto texto texto texto texto texto texo texto texto texto Texto texto texto texto texo texto texto texto texto texto texto texo texto texto texto texto texto texto texo texto
      texto texto texto texto texto texto texo texto texto texto texto texto texto texo texto texto texto texto texto texo
      texto texto texto texto texto texto texo texto texto texto texto texto texto 
    </p>
  </div>
</div>
        ...
        <footer className="bg-gray-50" aria-labelledby="footer-heading">
          ...
          <div className="w-full ">
            <div className="xl:grid xl:grid-cols-3 xl:gap-8">
              <div className="space-y-8 xl:col-span-1 ml-5">
                <img
                  className="h-10 ml-3s"
