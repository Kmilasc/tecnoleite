        ...
        <div id="inicio" className="relative">
            ...
            <div className="w-full text-2xl xs:text-4xl sm:text-6xl text-center font-conforter absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white font-extrabold border-spacing-1 p-4">
                ...
                <div className="text-xs xs:text-lg  sm:text-3xl font-bold whitespace-pre-wrap">
                    ...
                    <button
                        type="button"
                        className="transition ease-in-out text-white bg-gradient-to-r border-[6px] border-main-800 hover:border-white from-main-400 via-main-500 to-main-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-main-300 dark:focus:ring-main-800 font-medium rounded-3xl text-4xl px-12 py-5 text-center"
                    >
                        Inscrição
                    </button>
                </div>
