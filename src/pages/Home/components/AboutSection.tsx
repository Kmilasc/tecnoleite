...
export function AboutSection({ title, text, imageUrl }: Props) {
    return (
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10" id="about-section">
            ...
            <img
                className="flex-1 float-right w-96 lg:w-[600px] xl:w-full max-w-[330px] drop-shadow-lg place-self-center"
                src={imageUrl}
                alt="ilustration"
            />
        </div>
